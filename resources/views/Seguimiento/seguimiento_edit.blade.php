...
<div class="container-fluid w-100" style="max-width:1200px">
    ...
    <div class="col-md-6">
        ...
        <div class="card-body">
                ...
                <?php
                    ...
                    $beneficario = $solicitud_edit->beneficiario;
                ...
                <div class="form-group">
                    ...
                    <div style="text-align:left;">
                        ...
                        {!! Form::label('nombre',trans('message.solicitud_action.nombre'), ['class' => 'control-label']) !!}<span class="required" style="color:red;">*</span>

                        {!! Form::text('nombre',isset($solicitud_edit->nombre) ?$solicitud_edit->nombre: '',['placeholder' => trans('message.solicitud_action.nombre'),'class' => 'form-control','id' => 'nombrebeneficiario_user' , 'disabled' => true]) !!}
                    ...
                    <div style="text-align:left;">
                        ...
                        {!! Form::text('cedula',isset($solicitud_edit->cedula) ?$solicitud_edit->cedula: '',['placeholder' => trans('message.solicitud_action.cedula'),'class' => 'form-control','id' => 'cedulabeneficiario_user' , 'disabled' => true]) !!}

                    </div>

                    <div style="text-align:left;">

                        {!! Form::label('fechanacimiento', 'FECHA DE ENTREGA', ['class' => 'control-label']) !!}<span

                            class="required" style="color:red;">*</span>

                        {!! Form::text('fechanacimiento', isset($solicitud_edit->fecha) ? $solicitud_edit->fecha : '', ['placeholder' => 'Fecha de Nacimiento', 'class' => 'form-control', 'id' => 'fechanacimiento_user', 'disabled' => true]) !!}
                    ...
                    <div style="text-align:left;">
                        ...
                        @if($rols_id == 10)
                            ...
                            <div style="text-align:left;">
                                ...
                                {!! Form::label('solicita', 'BENEFICIO', ['class' => 'control-label']) !!}<span class="required" style="color:red;">*</span>

                                {!! Form::textarea('solicita', isset($valores[0]["solicita"]) ?$valores[0]["solicita"]: '',['placeholder' => 'Solicita','class' => 'form-control','id' => 'solicita_user' , 'disabled' => true]) !!}
            ...
            <div class="-dialog">
                ...
                <div class="-content">
                    ...
                    <div class="-header">
                        ...
                        <h3 style="justify-content: center; font-size:20px;">Adjuntar Evidencias</h3>
      ...
      <div class="modal-body">
        ...
        <form id="formMedicinas" method="POST" action="{{ route('seguimiento.store2') }}">
          ...
          <div style="text-align:left;">
                        ...
                        <select required name="tipoentrada" id="tipoentrada" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins">
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="col-md-6">
            ...
            <div class="row table-borderless">
                ...
                <iframe class="embed-responsive-item" style="width: 100%; height: 800px; overflow: visible;" src="http://192.168.250.11:7000/iframe/buscarsolicitud?param={{$solicitud_edit->cedula}}" allowfullscreen frameborder="0"></iframe>
...
@section('script_datatable')
            ...
            $(document).ready(function() {
                $('#producto_id').prepend('<option value="" selected>Seleccionar una opción</option>');
...
$('#producto_id').on('change', function() {
    ...
    var tipoEntrada = $('#tipoentrada').val(); // Obtener el valor de tipoentrada
    ...
    $.ajax({
        ...
        data: {
            id: productoID,
            tipoentrada: tipoEntrada // Agregar tipoentrada a los datos
        },
...
$('#tipoentrada').on('change', function() {
    if ($(this).val() !== 'SELECCIONE UNA OPCION') {
        ...
        // Agregar esta línea para seleccionar la opción por defecto
        $('#producto_id option:first').prop('selected', true);
        $('#cantidad').val(0); // Limpiar la cantidad
        $('#existencia').val(0); // Limpiar la existencia
    } else {
        $('#producto_id').prop('disabled', true);
    }
});
