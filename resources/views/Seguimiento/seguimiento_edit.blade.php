  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="col-md-6">
            ...
            <div class="row table-borderless">
                ...
                <iframe class="embed-responsive-item" style="width: 100%; height: 800px; overflow: visible;" src="http://192.168.0.123:4000/iframe/buscarsolicitud?param={{$solicitud_edit->cedula}}" allowfullscreen frameborder="0"></iframe>
