...
<div class="container table-borderless" >
    <div class="col-md-6 col-sm-6 table-borderless" >
        ...
        <iframe class="embed-responsive-item" style="width: 100%; height: 795px; overflow: hidden;" src="http://192.168.0.113:7001/producto2" allowfullscreen seamless frameborder="0"></iframe>
        </div>
    </div>
    <div class="col-md-6 col-sm-6 table-borderless" >
        <div class="row table-borderless">
            <iframe class="embed-responsive-item" style="width: 100%; height: 800px" src="http://192.168.0.113:9000/#/consultar" allowfullscreen frameborder="0"></iframe>
        </div>
    </div>

    <div class="col-md-6 col-sm-6 table-borderless" >
        <div class="row table-borderless">
            <iframe class="embed-responsive-item" style="width: 100%; height: 1000px" src="http://192.168.0.113:9000/#/pie" allowfullscreen frameborder="0"></iframe>
        </div>
    </div>
    <div class="col-md-6 col-sm-6 table-borderless" >
        <div class="row table-borderless">
            <iframe class="embed-responsive-item" style="width: 100%; height: 1000px" src="http://192.168.0.113:9000/#/pie2" allowfullscreen frameborder="0"></iframe>
        </div>
    </div>
</div>
