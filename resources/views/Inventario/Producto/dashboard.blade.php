...
<div class="container table-borderless" >
    <div class="col-md-6 col-sm-6 table-borderless" >
        ...
        <iframe class="embed-responsive-item" style="width: 100%; height: 795px; overflow: hidden;" src="http://192.168.0.123:4000/producto2" allowfullscreen seamless frameborder="0"></iframe>
        </div>
    </div>
    <div class="col-md-6 col-sm-6 table-borderless" >
        <div class="row table-borderless">
