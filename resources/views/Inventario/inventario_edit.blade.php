        ...
        <div class="card-body">
            <div class="col-lg-12 col-xs-12">
                ...
                <div style="text-align:left;">
                    ...
                    <div style="text-align:left;">
                        {!! Form::label('responsable','Responsable', ['class' => 'control-label']) !!}<span class="required" style="color:red;">*</span>
                        {!! Form::text('responsable',$inventario->responsable,['class' => 'form-control','id' => 'name_description']) !!}
                    </div>
                    <div style="text-align:left;">
                        {!! Form::label('autorizado','Autorizado', ['class' => 'control-label']) !!}<span class="required" style="color:red;">*</span>
                        {!! Form::text('autorizado',$inventario->autorizado,['class' => 'form-control','id' => 'name_description']) !!}
                    </div>
                    <div style="text-align:left;">
                        {!! Form::label('motivo','Motivo', ['class' => 'control-label']) !!}<span class="required" style="color:red;">*</span>
                        {!! Form::text('motivo',$inventario->motivo,['class' => 'form-control','id' => 'name_description']) !!}
                    </div>
