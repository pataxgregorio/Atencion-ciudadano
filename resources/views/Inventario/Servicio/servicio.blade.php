...
<div >
    ...
    <a href="/servicio/create"><button style="color: white; background-color: black; width: 200px;border-radius: 7px;height: 30px; font-size: 16px;">Nuevo Servicio</button></a>
